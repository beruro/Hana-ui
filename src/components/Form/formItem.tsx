...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames("fish-row", {
    "fish-row-no-label": !label,
  });
  useEffect(() => {
  ...
  const labelClass = classNames({
    "fish-form-item-required": isRequired,
  });
  const itemClass = classNames("fish-form-item-control", {
    "fish-form-item-has-error": hasError,
  });
  ...
  return (
    <div className={rowClass}>
      {label && (
        <div className="fish-form-item-label">
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      )}
      <div className="fish-form-item">
        <div className={itemClass}>{returnChildNode}</div>
        {hasError && (
          <div className="fish-form-item-explain">
